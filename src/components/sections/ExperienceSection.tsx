...
const ExperienceSection = () => {
  const experiences = [{
    ...
    period: "2023 - Present",
    achievements: ["Led high-impact engineering projects, including fuel-saving retrofits and in-house oil blending systems — saving over $940K annually and reducing emissions by 15%", "Oversaw critical shipboard operations like $1.7M bunkering and emergency drill leadership for 20+ crew — maintaining zero safety incidents and full regulatory compliance", "Mentored cadets and improved safety culture as engine department Safety Rep and cadet-in-charge, contributing to a 100% issue resolution rate and producing future officers"]
  }, {
      ...
      <div className="container mx-auto px-6 relative z-10 py-[33px]">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            ...
            {experiences.map((exp, index) => <div key={exp.title} className={`relative flex items-center mb-12 ${index % 2 === 0 ? "md:flex-row" : "md:flex-row-reverse"}`}>
                {/* Timeline dot */}
                ...
                <div className={`w-full md:w-1/2 ${index % 2 === 0 ? "md:pr-8" : "md:pl-8"} ml-10 md:ml-0`}>
                  <div className="card-marine slide-in-view" style={{
                animationDelay: `${index * 0.2}s`
                    ...
                    <ul className="space-y-2">
                      {exp.achievements.map((achievement, i) => <li key={i} className="text-white/90 text-sm leading-relaxed flex">
