...
const VisionSection = () => {
  ...
  return <section id="vision" className="section-base min-h-screen flex items-center relative">
      {/* Particle animation */}
      <div className="absolute inset-0 opacity-30">
        {[...Array(30)].map((_, i) => <div key={i} className="absolute w-0.5 h-0.5 bg-white rounded-full animate-pulse" style={{
      ...
      <div className="container mx-auto px-6 relative z-10 py-[30px]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Vision title */}
          <div className="mb-16 slide-in-view" style={{
          animationDelay: "0.2s"
        }}>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {pillars.map((pillar, index) => <div key={pillar.title} className="card-marine text-center slide-in-view cursor-pointer" style={{
          ...
          {/* Call to action */}
          <div className="mt-16 slide-in-view flex flex-col items-center space-y-4" style={{
          animationDelay: "1s"
        }}>
